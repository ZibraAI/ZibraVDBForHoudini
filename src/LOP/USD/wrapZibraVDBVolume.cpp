...
static UsdAttribute
_CreateFilePathAttr(ZibraVDBZibraVDBVolume &self,
...
static std::string
_Repr(const ZibraVDBZibraVDBVolume &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "ZibraVDBVolume.ZibraVDBVolume(%s)",
        primRepr.c_str());
}

} // anonymous namespace

void wrapZibraVDBZibraVDBVolume()
{
    typedef ZibraVDBZibraVDBVolume This;
